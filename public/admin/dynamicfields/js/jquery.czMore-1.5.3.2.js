    ...
    $.fn.czMore = function (options) {
        ...
        return this.each(function () {
            ...
            btnPlus.css({
                'float': 'right',
                'border': '0px',
                'background-image': 'url("http://localhost/ecomm/public/admin/dynamicfields/img/add.png")',
            ...
            function loadMinus(recordset) {
                ...
                btnMinus.css({
                    'float': 'right',
                    'border': '0px',
                    'background-image': 'url("http://localhost/ecomm/public/admin/dynamicfields/img/remove.png")',
                    'background-position': 'center center',
                    'background-repeat': 'no-repeat',
                    'height': '25px',
                    'width': '25px',
